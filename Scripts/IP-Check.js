...
!(async () => {
  ...
  const domesticIPv4Info = `${domesticIPv4.flag || '🏴‍☠️'} ${domesticIPv4.aso || '-'} ${domesticIPv4.ip || '-'}`
  const domesticIPv6Info = `${domesticIPv6.flag || '🏴‍☠️'} ${domesticIPv6.aso || '-'} ${domesticIPv6.ip || '-'}`
  const foreignIPv4Info = `${foreignIPv4.flag || '🏴‍☠️'} ${foreignIPv4.aso || '-'} ${foreignIPv4.ip || '-'}`
  const foreignIPv6Info = `${foreignIPv6.flag || '🏴‍☠️'} ${foreignIPv6.aso || '-'} ${foreignIPv6.ip || '-'}`
