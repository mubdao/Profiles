...
(async () => {
    try {
        try {
            ...
            if (data.nw || data.version !== pro.version || typeof data.hideIP !== "boolean" || typeof data.GPT !== "boolean" || typeof data.icons !== "string" || typeof data.icolor !== "string") {
...
async function tKey(e, t) {
    ...
    const a = new Promise(((a, i) => {
        const l = async r => {
            try {
                const s = await Promise.race([new Promise(((t, s) => {
                    let o = Date.now();
                    $httpClient.get({
                        url: e
                    }, ((e, n, a) => {
