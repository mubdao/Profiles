  ...
  try {
    try {
      ...
      if (
        ...
        typeof data.cnTimeout !== "number" ||
        typeof data.usTimeout !== "number" ||
        typeof data.updata !== "object"
      ) {
    ...
    if (y == i) {
      ...
      if (!w || I) {
        ...
        if (e.code === 0 && e.data.country === "中国") {
          let { province: t, isp: o, city: s, countryCode: n } = e.data,
            i = e.tk;
          cn = true;
          a && (y = HIP(y));
          p =
...
function HIP(e) {
  return e.replace(
    /(\w{1,4})(\.|\:)(\w{1,4})$/,
    (e, t, o, a) => `${"∗".repeat(t.length)}.${"∗".repeat(a.length)}`
  );
}
