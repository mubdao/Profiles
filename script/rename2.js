...
function jxh(e) {const n=e.reduce((e,n)=>(t=e.find((e)=>e.name===n.name),t?(t.count++,t.items.push({...n,name:`${n.name}${XHFGF}${t.count.toString()}`})):e.push({name:n.name,count:1,items:[{...n,name:`${n.name}${XHFGF}01`}]},e),[]),t=n.flatMap((e)=>e.items);e.splice(0,e.length,...t);return e;}
function oneP(e) {const t=e.reduce((e,t)=>(n=t.name.replace(/\[^A-Za-z0-9\\u00C0-\\u017F\\u4E00-\\u9FFF\]+\\d+$/,""),e[n]?e[n].push(t):e[n]=[t],e),{});for(const e in t)t[e].length===1&&(n=t[e][0],n.name=e);return e;}
