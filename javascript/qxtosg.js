...
Surge:
[Script]
Qx_Surge = type=http-request,pattern=qx$,requires-body=1,max-size=0,script-path=https://raw.githubusercontent.com/mubdao/Profiles/main/javascript/qxtosg.js
*/
				...
				if (type.match("url ")) {
					...
					script.push(
						x.replace(
							...
							`test = type=$2,pattern=$1,requires-body=1,script-path=https://raw.githubusercontent.com/mubdao/Profiles/main/surge/mocks/replace-body.js, argument=$3->$4`,
						),
					);
				}
		} //switch结束
